...
export default function Createuser() {
  ...
  const AdminForm = () => {
    ...
    const handleSubmit = async (event) => {
      ...
      setError("");
      if (!enabled) {
        setError("Your account needs to be enabled before you can create user");
      } else {
        try {
    ...
    return (
      <form className="space-y-6 w-full px-6" onSubmit={handleSubmit}>
        ...
        <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
          ...
          {/* Email */}
          <label htmlFor="email" className="text-gray-700 text-lg font-bold">
            Email
          </label>
          <div className="mt-2 sm:col-span-2 sm:mt-0">
            <input
          ...
          {/* Password */}
          <label htmlFor="password" className="text-gray-700 text-lg font-bold">
            Password
          </label>
          <div className="mt-2 sm:col-span-2 sm:mt-0">
            <input
          ...
          {/* Enterprise Name */}
          <label htmlFor="ent-name" className="text-gray-700 text-lg font-bold">
            Enterprise Name
          </label>
          <div className="mt-2 sm:col-span-2 sm:mt-0">
            <input
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
          ...
          >
            ...
            {/* change the button text based on the isSubmitting state */}
          </button>
        </div>
      </form>
    );
  ...
  const EntForm = () => {
    ...
    const [data, setData] = useState({
      ...
      entName: auth.result.entName,
      entID: auth.result.entID,
    });
              ...
              <div className="mt-8">
                <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
                    {hasAdminRole ? <AdminForm /> : <EntForm />}
                  </div>
                </div>
              </div>
            </div>
